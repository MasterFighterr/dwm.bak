...
static const char blue[]            = "#182051";
static const char black[]	    = "#000000";
static const char yellow[]	    = "#faf881";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { yellow, blue, blue },
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", blue, "-nf", yellow, "-sb", yellow, "-sf", black, NULL };
